    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            try {
                ...
                Toast.makeText(AddProductforSale.this, "Изображение сохранено!", Toast.LENGTH_SHORT).show();
                //get the path of the image
                photo_taken.setImageBitmap(bitmap);
            }catch (IOException e){
                e.printStackTrace();
                Toast.makeText(AddProductforSale.this, "Не удается сохранить изображение",Toast.LENGTH_SHORT).show();
            }
        }
    }
