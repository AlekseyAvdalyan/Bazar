        ...
        add_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(card_number.isEmpty()||ccv_card.isEmpty()||ccv_date.isEmpty()||mailing_add.isEmpty()){
                    Toast toast = Toast.makeText(v.getContext(),"Поля не могут быть пустыми", Toast.LENGTH_SHORT);
                    toast.show();
                }
                else {
                    ...
                    Toast toast = Toast.makeText(v.getContext(),"Добавлена новая карта!", Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
        });
