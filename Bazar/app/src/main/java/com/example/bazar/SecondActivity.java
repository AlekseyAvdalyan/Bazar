        ...
        buy_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(address_field.getText()!=null){
                    ...
                    Toast toast = Toast.makeText(v.getContext(),"Купленные товары!!",Toast.LENGTH_SHORT);
                    toast.show();
        ...
        payment.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(data!=null){
                    ...
                    Toast toast = Toast.makeText(getApplicationContext(), "Не удается подключиться к базе данных",Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
