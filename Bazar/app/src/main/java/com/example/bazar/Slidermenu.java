    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Продать товар", Snackbar.LENGTH_LONG)
        ...
        products.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(data!=null){
                    ...
                    Toast toast = Toast.makeText(getApplicationContext(),"В настоящее время в продаже нет товаров",Toast.LENGTH_LONG);
                    toast.show();
                }
            ...
            products.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(data !=null){
                        ...
                        Toast toast = Toast.makeText(getApplicationContext(),"У Вас нет текущих товаров в продаже",Toast.LENGTH_LONG);
                        toast.show();
                    }
                }
